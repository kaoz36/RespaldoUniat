...
public class MainActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		pressButtom(expedientes, Expediente.class);
		//TODO:Faltan
		final ImageButton datos = (ImageButton) mthis.findViewById(R.id.datos);
		final ImageButton salones = (ImageButton) mthis.findViewById(R.id.salones);
		final ImageButton actividades = (ImageButton) mthis.findViewById(R.id.actividades);
		final ImageButton ajustes = (ImageButton) mthis.findViewById(R.id.ajustes);
		pressButtom(datos, Splash.class);
		pressButtom(salones, Splash.class);
		pressButtom(actividades, Splash.class);
		pressButtom(ajustes, Splash.class);
	}
