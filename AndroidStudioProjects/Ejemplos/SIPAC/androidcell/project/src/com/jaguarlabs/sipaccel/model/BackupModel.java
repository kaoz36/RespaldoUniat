...
import com.jaguarlabs.sipaccel.util.AsyncObjectResponseProcessor;
import com.jaguarlabs.sipaccel.util.AsyncResponseProcessor;
import com.jaguarlabs.sipaccel.util.ExtendedActivity;
import com.jaguarlabs.sipaccel.util.ExtendedFragmentActivity;
import com.jaguarlabs.sipaccel.util.IAsyncJSONResponseHandler;
...
public class BackupModel {
	...
	/*----------------------------------- Functionality ---------------------------------------------*/
	private ExtendedFragmentActivity mActivity;
