...
- (void)viewDidLoad
{
    ...
    self.interesGarantizado = [profile[@"interes_garantizado"] floatValue] / 100;
    self.costoAdministracion = 0.005;
    
    self.txtInteresGarantizado.text = [NSString stringWithFormat:@"%.01f",[profile[@"interes_garantizado"] floatValue]];
    self.txtCostoAdministrativo.text = @"0.5";
...
-(void)textFieldDidEndEditing:(UITextField *)textField {
    double value = [textField.text doubleValue] / 100;
    if ([textField isEqual:self.txtInteresGarantizado]) {
        self.interesGarantizado = value;
    }else{
        //double value = [textField.text doubleValue] / 1000;
...
- (NSString *)stringFromDouble:(double)dato
{
    ...
    return [formatter stringFromNumber:[NSNumber numberWithDouble:dato]];
...
-(NSString *)stringCotizacion2OaniosWithDictionary:(NSDictionary *)dictionary array:(NSArray *)array {
    ...
    prospeccionString = [NSString stringWithFormat:
                         ...
                         </table>%@", formaDePago, primaExedente, formaDePago, primaTotalAnual,primaDiaria,formaDePago, estructuraTablaCotizacion];
