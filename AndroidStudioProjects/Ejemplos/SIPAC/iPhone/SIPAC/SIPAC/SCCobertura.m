    ...
    switch (self.type) {
        ...
        case SCCoberturaTypeGFH:{
            ...
            if([UIDevice currentDevice].userInterfaceIdiom==UIUserInterfaceIdiomPhone) {
                ...
                if ([self.GFHDescription isEqualToString:@"SGFH"] || [self.GFHDescription isEqualToString:@"Sin Hijos"]) {
                    valorGFH = 0;
                }else if ([self.GFHDescription isEqualToString:@"GFH: 1 Hijo"]) {
                    valorGFH = 136;
                }else if ([self.GFHDescription isEqualToString:@"GFH: 2 Hijos"]){
                    valorGFH = 276;
                }else{
                    valorGFH = 409;
                }
                ...
                if ([self.GFHDescription isEqualToString:@"Sin gastos funerarios hijos"] || [self.GFHDescription isEqualToString:@"Sin Hijos"]) {
                    valorGFH = 0;
                }else if ([self.GFHDescription isEqualToString:@"GFH: 1 Hijo"]) {
                    valorGFH = 136;
                }else if ([self.GFHDescription isEqualToString:@"GFH: 2 Hijos"]){
        ...
        case SCCoberturaTypeCP1:{
            ...
            if ([self.sexCP isEqualToString:@"M"]){
                if (self.esConDevolucion) {// cotizador 1 y cotizador 2
                    CAT = [[getValue objectForKey:@"BCAT"]doubleValue]* 100;
                }else{//cotizador 3 y cotizador 4
                    CAT = [[getValue objectForKey:@"BCATN"]doubleValue]* 100;
