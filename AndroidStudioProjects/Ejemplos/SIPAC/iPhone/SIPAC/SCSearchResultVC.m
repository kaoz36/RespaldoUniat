...
- (void)viewDidLoad
{
    ...
    //self.LblResult.text = [NSString stringWithFormat:@"Resultados para : %@",@"AAR073"];
        [[SCWebServicesMgr sharedInstance] SWSaveLocationWithSendLocationType:sendLocationTypeHistory AndDelegate:Nil];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UITextView *tmpTxtViewNombre = (UITextView*)[cell viewWithTag:2];
    tmpTxtViewNombre.text = [dic objectForKey:@"nombre_poliza"];
