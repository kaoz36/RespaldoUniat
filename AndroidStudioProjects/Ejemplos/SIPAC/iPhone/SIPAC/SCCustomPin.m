...
- (void)makeCheckIn{
    [SCWebServicesMgr WSMakeCheckInLatidude:self.theCoordinate.latitude Longitude:self.theCoordinate.longitude PlaceId:(int)[self.placeId integerValue] Delegate:self];
}
