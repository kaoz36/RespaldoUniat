...
public class BDFamilia extends BDConectar {
	...
	public static void updateFamilia( Familia f ){
		...
		if ( f.getId() == 0 ) {
			// Si el Id de la Familia est� a cero es una nueva fila.
			q = "INSERT INTO familia ( id, nombre ) VALUES ( " +
				f.getId() + ", " +
				f.getNombre() + ")";			
		} else {
			// Si el id es distinto de cero es una actualizaci�n del registro.
