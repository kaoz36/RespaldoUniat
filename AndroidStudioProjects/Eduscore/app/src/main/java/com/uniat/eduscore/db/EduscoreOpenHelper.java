...
public class EduscoreOpenHelper extends SQLiteOpenHelper{
    ...
    public static final String TABLE_NEW_REGISTRO = "new_registro";
    public static final String TABLE_NEW_CORREOS = "new_correos";
    public static final String TABLE_NEW_TELEFONOS = "new_telefonos";
    public static final String TABLE_NEW_INTERESES = "new_intereses";
    ...
    public static final String CREATE_NEW_REGISTROS = "CREATE TABLE IF NOT EXISTS " + TABLE_NEW_REGISTRO + "(" +
            " idRegistro VARCHAR(25) PRIMARY KEY, " +
            " nombre VARCHAR(25), " +
            " apellidos VARCHAR(35), " +
            " tipoIntereses VARCHAR(25), " +
            " horario VARCHAR(35), " +
            " medio VARCHAR(25), " +
            " lugar VARCHAR(35), " +
            " evento VARCHAR(25), " +
            " probabilidad VARCHAR(35), " +
            " paisResidencia VARCHAR(25), " +
            " estadoResidencia VARCHAR(35), " +
            " ciudadResidencia VARCHAR(25), " +
            " calle VARCHAR(35), " +
            " numExt VARCHAR(25), " +
            " numInt VARCHAR(35), " +
            " colonia VARCHAR(25), " +
            " cp VARCHAR(35), " +
            " curp VARCHAR(25), " +
            " paisOrigen VARCHAR(35), " +
            " estadoOrigen VARCHAR(25), " +
            " ciudadOrigen VARCHAR(35), " +
            " fechaNacimiento VARCHAR(25))";

    public static final String CREATE_NEW_CORREOS = "CREATE TABLE IF NOT EXISTS " + TABLE_NEW_CORREOS + "(" +
            " idCorreo INTEGER PRIMARY KEY AUTOINCREMENT, " +
            " idRegistro VARCHAR(35), " +
            " correo VARCHAR(25))";

    public static final String CREATE_NEW_TELEFONOS = "CREATE TABLE IF NOT EXISTS " + TABLE_NEW_TELEFONOS + "(" +
            " idTelefono INTEGER PRIMARY KEY AUTOINCREMENT, " +
            " idRegistro VARCHAR(35), " +
            " telefono VARCHAR(35), " +
            " tipo VARCHAR(25))";

    public static final String CREATE_NEW_INTERESES = "CREATE TABLE IF NOT EXISTS " + TABLE_NEW_INTERESES + "(" +
            " idInteres INTEGER PRIMARY KEY AUTOINCREMENT, " +
            " idRegistro VARCHAR(35), " +
            " idCareer VARCHAR(25))";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(CREATE_NEW_REGISTROS);
        db.execSQL(CREATE_NEW_CORREOS);
        db.execSQL(CREATE_NEW_TELEFONOS);
        db.execSQL(CREATE_NEW_INTERESES);
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_NEW_REGISTRO);
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_NEW_CORREOS);
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_NEW_TELEFONOS);
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_NEW_INTERESES);
        onCreate(db);
    }
