...
public class AdicionalesFragment extends Fragment {
    ...
    private void loadSpinner(){
        ...
        ArrayAdapter<String> spinnerProbabilidadAdapter = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_spinner_item, arrayProbabilidad);
        ...
        ArrayAdapter<String> spinnerMedioAdapter = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_spinner_item, arrayMedias);
        ...
        ArrayAdapter<String> spinnerEventAdapter = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_spinner_item, arrayEvents);
        ...
        ArrayAdapter<String> spinnerProcedenciaAdapter = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_spinner_item, arrayLugar);
    ...
    private String getIdCampus(){
        ...
        CommonDAO<PersonVO> personDAO = new CommonDAO<PersonVO>(getActivity(), PersonVO.class, EduscoreOpenHelper.TABLE_DAT_PERSON);
        personDAO.open();
    ...
    private String[] getMediasArray(){
        List<MediaVO> mediaVO = new ArrayList<MediaVO>();
        CommonDAO<MediaVO> mediaDAO = new CommonDAO<MediaVO>(getActivity(), MediaVO.class, EduscoreOpenHelper.TABLE_DAT_MEDIA);
        mediaDAO.open();
        ...
        mediaVO.add(0, new MediaVO("00", getString(R.string.text_medio_selected), "1", "00"));
    ...
    private String[] getEventsArray(){
        ...
        CommonDAO<EventVO> eventDAO = new CommonDAO<EventVO>(getActivity(), EventVO.class, EduscoreOpenHelper.TABLE_DAT_EVENTS);
        eventDAO.open();
        String sql = "SELECT * FROM " + EduscoreOpenHelper.TABLE_DAT_EVENTS +
                " WHERE idCampus = '" + getIdCampus() + "' AND status = '1' GROUP BY name";
        eventVO = eventDAO.runQuery( sql );
        eventVO.add(0, new EventVO("00", getString(R.string.text_evento_procedencia_selected), "1", "00"));
    ...
    private String[] getOriginsArray(){
        ...
        CommonDAO<OriginVO> originDAO = new CommonDAO<OriginVO>(getActivity(), OriginVO.class, EduscoreOpenHelper.TABLE_DAT_ORIGIN);
        originDAO.open();
        String sql = "SELECT * FROM " + EduscoreOpenHelper.TABLE_DAT_ORIGIN +
                " WHERE idCampus = '" + getIdCampus() + "' AND status = '1' GROUP BY name";
        originVO = originDAO.runQuery( sql );
        originVO.add(0, new OriginVO("00", getString(R.string.text_procedencia_selected), "00", "00", "00"));
