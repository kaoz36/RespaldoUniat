...
public class BackupModel {
    ...
    protected ProgressDialog getDialog() {
        if (dialog == null) {
            dialog = ProgressDialog.show(mActivity.getMContext(), mActivity.getString(R.string.text_progress), "", true);
    ...
    private int maxElementUser(String table){
        ...
        CommonDAO<UserVO> user = new CommonDAO<UserVO>(mActivity.getMContext(), UserVO.class, table);
        user.open();
    ...
    private int maxElementCareers(String table){
        List<CareerVO> results = new ArrayList<CareerVO>();
        CommonDAO<CareerVO> career = new CommonDAO<CareerVO>(mActivity.getMContext(), CareerVO.class, table);
        career.open();
    ...
    private int maxElementCareersType(String table){
        List<CareerTypeVO> results = new ArrayList<CareerTypeVO>();
        CommonDAO<CareerTypeVO> careerType = new CommonDAO<CareerTypeVO>(mActivity.getMContext(), CareerTypeVO.class, table);
        careerType.open();
    ...
    private int maxElementMedia(String table){
        List<MediaVO> results = new ArrayList<MediaVO>();
        CommonDAO<MediaVO> media = new CommonDAO<MediaVO>(mActivity.getMContext(), MediaVO.class, table);
        media.open();
    ...
    private int maxElementCampus(String table){
        List<CampusVO> results = new ArrayList<CampusVO>();
        CommonDAO<CampusVO> campus = new CommonDAO<CampusVO>(mActivity.getMContext(), CampusVO.class, table);
        campus.open();
    ...
    private int maxElementEvents(String table){
        ...
        CommonDAO<EventVO> events = new CommonDAO<EventVO>(mActivity.getMContext(), EventVO.class, table);
        events.open();
    ...
    private int maxElementOrigins(String table){
        List<OriginVO> results = new ArrayList<OriginVO>();
        CommonDAO<OriginVO> origins = new CommonDAO<OriginVO>(mActivity.getMContext(), OriginVO.class, table);
        origins.open();
    ...
    private int maxElementEmail(String table){
        List<EmailVO> results = new ArrayList<EmailVO>();
        CommonDAO<EmailVO> email = new CommonDAO<EmailVO>(mActivity.getMContext(), EmailVO.class, table);
        email.open();
    ...
    private int maxElementCountry(String table){
        List<CountryVO> results = new ArrayList<CountryVO>();
        CommonDAO<CountryVO> country = new CommonDAO<CountryVO>(mActivity.getMContext(), CountryVO.class, table);
        country.open();
    ...
    private int maxElementRegion(String table){
        List<RegionVO> results = new ArrayList<RegionVO>();
        CommonDAO<RegionVO> region = new CommonDAO<RegionVO>(mActivity.getMContext(), RegionVO.class, table);
        region.open();
    ...
    private int maxElementCity(String table){
        List<CityVO> results = new ArrayList<CityVO>();
        CommonDAO<CityVO> city = new CommonDAO<CityVO>(mActivity.getMContext(), CityVO.class, table);
        city.open();
    ...
    private int maxElementPerson(String table){
        ...
        CommonDAO<PersonVO> person = new CommonDAO<PersonVO>(mActivity.getMContext(), PersonVO.class, table);
        person.open();
    ...
    private int maxElementPersonDescription(String table){
        List<PersonDescriptionVO> results = new ArrayList<PersonDescriptionVO>();
        CommonDAO<PersonDescriptionVO> person = new CommonDAO<PersonDescriptionVO>(mActivity.getMContext(), PersonDescriptionVO.class, table);
        person.open();
        results = person.runQuery("Select * FROM " + table);
        return results.size();
    }
    ...
    private void backupCareers( final int index ) {
        ...
        datadownlooader = new RPCHandlerString(new IAsyncStringResponseHandler() {
            ...
            @Override
            public void onRequest() {
                //TODO:getDialog().setMessage("Respaldando Carreras " + index + " / " + count);
                getDialog().setMessage(index + " / " + count);
            }
    ...
    private void backupCareersType( final int index) {
        ...
        datadownlooader = new RPCHandlerString(new IAsyncStringResponseHandler() {
            ...
            @Override
            public void onRequest() {
                //TODO:getDialog().setMessage("Respaldando Tipos de Carrera " + index + " / " + count);
                getDialog().setMessage(index + " / " + count);
            }
    ...
    private void backupMedia(final int index) {
        ...
        datadownlooader = new RPCHandlerString(new IAsyncStringResponseHandler() {
            ...
            @Override
            public void onRequest() {
                //TODO:getDialog().setMessage("Respaldando Medios " + index + " / " + count);
                getDialog().setMessage(index + " / " + count);
            }
    ...
    private void backupCampus(final int index) {
        ...
        datadownlooader = new RPCHandlerString(new IAsyncStringResponseHandler() {
            ...
            @Override
            public void onRequest() {
                //TODO:getDialog().setMessage("Respaldando Tipos de Campus " + index + " / " + count);
                getDialog().setMessage(index + " / " + count);
    ...
    private void backupEvents(final int index) {
        ...
        datadownlooader = new RPCHandlerString(new IAsyncStringResponseHandler() {
            ...
            @Override
            public void onRequest() {
                //TODO:getDialog().setMessage("Respaldando Eventos " + index + " / " + count);
                getDialog().setMessage(index + " / " + count);
            }
    ...
    private void backupEmail(final int index) {
        ...
        datadownlooader = new RPCHandlerString(new IAsyncStringResponseHandler() {
            ...
            @Override
            public void onRequest() {
                //TODO:getDialog().setMessage("Respaldando Correos " + index + " / " + count);
                getDialog().setMessage(index + " / " + count);
    ...
    private void backupCountry(final int index) {
        ...
        datadownlooader = new RPCHandlerString(new IAsyncStringResponseHandler() {
            ...
            @Override
            public void onRequest() {
                //TODO:getDialog().setMessage("Respaldando Paises " + index + " / " + count);
                getDialog().setMessage(index + " / " + count);
    ...
    private void backupRegion(final int index) {
        ...
        datadownlooader = new RPCHandlerString(new IAsyncStringResponseHandler() {
            ...
            @Override
            public void onRequest() {
                //TODO:getDialog().setMessage("Respaldando Estados " + index + " / " + count);
                getDialog().setMessage(index + " / " + count);
            }
