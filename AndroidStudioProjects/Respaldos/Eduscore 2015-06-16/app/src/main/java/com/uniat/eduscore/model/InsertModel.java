...
public class InsertModel implements ICallback{
    ...
    List<NewCorreosVO> newCorreoVO = new ArrayList<>();
    ...
    public void setContextActivity(ExtendedFragmentActivity pActivity) {
        mActivity = pActivity;
        listIdPerson = new ArrayList<>();
        listIdTable = new ArrayList<>();
    }
    ...
    private String getIdCampus(){
        ...
        CommonDAO<PersonVO> personDAO = new CommonDAO<>(mActivity.getMContext(), PersonVO.class, EduscoreOpenHelper.TABLE_DAT_PERSON);
        personDAO.open();
    ...
    @Override
    public void time() {
        CommonDAO<NewRegistroVO> newRegistronDAO = new CommonDAO<>(mActivity.getMContext(), NewRegistroVO.class, EduscoreOpenHelper.TABLE_NEW_REGISTRO);
        CommonDAO<NewCorreosVO> newCorreoDAO = new CommonDAO<>(mActivity.getMContext(), NewCorreosVO.class, EduscoreOpenHelper.TABLE_NEW_CORREOS);
        CommonDAO<NewTelefonosVO> newTelefonoDAO = new CommonDAO<>(mActivity.getMContext(), NewTelefonosVO.class, EduscoreOpenHelper.TABLE_NEW_TELEFONOS);
        CommonDAO<NewInteresesVO> newInteresDAO = new CommonDAO<>(mActivity.getMContext(), NewInteresesVO.class, EduscoreOpenHelper.TABLE_NEW_INTERESES);
