...
public class NewRegistroVO implements ICursorDecoder{
    ...
    public void decode(Cursor pCursor) {
        ...
        setEstadoOrigen(pCursor.getString(19));
        setCiudadOrigen(pCursor.getString(20));
    ...
    public String getInsert(String idPerson){
        return idPerson + ", '" + getNombre() + "', '" + getApellidos() + "', '" + getFechaNacimiento() + "', " + getPaisOrigen() +
                ", " + getEstadoOrigen() + ", " + getCiudadOrigen() + ", " + getPaisResidencia() + ", " + getEstadoResidencia() +
                ", " + getCiudadResidencia() + ", '" + getCalle() + "', '" + getNumExt() + "', '" + getNumInt() + "', '" + getColonia() +
                "', '" +  getCp() + "', '" + getCurp() + "', '" + getProbabilidad() + "', " + getMedio() + ", " + getLugar() +
                ", " + getEvento() + ", " + getTipoInteres() + ", " + getHorarios();
    }
}
