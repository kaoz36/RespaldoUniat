...
public class CampusVO implements ICursorDecoder {
    ...
    public void decode(Cursor pCursor) {
        setIdCampus(pCursor.getString(1));
        setName(pCursor.getString(2));
        setAddress(pCursor.getString(3));
        setStatus(pCursor.getString(4));
        setIdContry(pCursor.getString(5));
        setIdRegion(pCursor.getString(6));
        setIdCity(pCursor.getString(7));
        setNameAlt(pCursor.getString(8));
